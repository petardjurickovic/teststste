...
<html>
    ...
    <body>
        ...
        <div id="create-course" class="content scaffold-create" role="main">
            <h1><g:message code="course.create.label" args="[entityName]" /></h1>
            ...
            <g:form resource="${this.course}" method="POST">
                ...
                <fieldset class="form">
                    <f:all bean="course" except="instructor,enrollments, categories, modules"/>
                    <g:hiddenField name="instructor" value="${sec.loggedInUserInfo(field: 'id')}" />
                </fieldset>
